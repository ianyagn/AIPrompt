  ...
  return (
    <>
      <div className="flex flex-col h-full bg-white border-[3px] border-black relative group hover:-translate-y-1 transition-transform duration-200">
        ...
        <div className="p-5 flex flex-col flex-grow">
          <div className="flex justify-between items-start mb-4 mt-2">
            <h2 className="text-xl font-black leading-tight text-black mr-2">{data.title}</h2>
            <span className="text-xs font-bold text-gray-400 shrink-0 pt-1 uppercase tracking-wide">{data.date}</span>
          </div>
          ...
          <p className="text-gray-600 text-sm mb-4 leading-relaxed flex-grow">{data.description}</p>
          ...
          <div className="bg-white border-[3px] border-black w-[600px] max-h-[min(600px,90vh)] max-w-[95vw] flex flex-col relative z-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar bg-white flex-1 space-y-6">
              <div>
                ...
                <div className="bg-gray-50 border-2 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
                  <pre className="whitespace-pre-wrap font-mono text-sm leading-relaxed text-gray-800 break-words">{data.promptCN}</pre>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 border-2 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
                  <pre className="whitespace-pre-wrap font-mono text-sm leading-relaxed text-gray-800 break-words">{data.promptEN}</pre>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-t-[3px] border-black bg-white flex justify-end gap-3 shrink-0">
               ...
               <button 
                 ...
                 className="px-4 py-2.5 border-2 border-black bg-white hover:bg-gray-100 font-bold text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-0.5 active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all flex items中心 gap-2"
               >
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                 英文
               </button>
      ...
      {isImageModalOpen && createPortal(
        ...
        >
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm transition-opacity animate-in fade-in duration-200"></div>
          <button 
            onClick={(e) => {
              e.stopPropagation();
